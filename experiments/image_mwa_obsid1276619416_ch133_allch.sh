...
do
   ...
   echo "blink_pipeline -c 4 -C $fine_channel_to_image -t 1.00s -o ch${ch_str}/ -n 8192 -f ${freq_mhz} -F 30 -M 20200619163000.metafits -U 1592584240 -w N -v 100 -r -L -G -s calsolutions_chan${ch_str}_xx.txt -r -V 100 1276619416_1276619418_ch133.dat > ch${ch_str}/out 2>&1"
   blink_pipeline -c 4 -C $fine_channel_to_image -t 1.00s -o ch${ch_str}/ -n 8192 -f ${freq_mhz} -F 30 -M 20200619163000.metafits -U 1592584240 -w N -v 100 -r -L -G -s calsolutions_chan${ch_str}_xx.txt -r -V 100 1276619416_1276619418_ch133.dat > ch${ch_str}/out 2>&1
