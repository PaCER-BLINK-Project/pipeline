...
do
   ...
   echo "calcfits_bg vis_re_cable_corr.fits = ${refdir}/1276619416_20200619163000_vis_real_channel${ch_str}_time000000_pol0.fits -p 0.5 -p 0.5"
   calcfits_bg vis_re_cable_corr.fits = ${refdir}/1276619416_20200619163000_vis_real_channel${ch_str}_time000000_pol0.fits -p 0.5 -p 0.5
   
   echo "calcfits_bg vis_im_cable_corr.fits = ${refdir}/1276619416_20200619163000_vis_imag_channel${ch_str}_time000000_pol0.fits -p 0.5 -p 0.5"
   calcfits_bg vis_im_cable_corr.fits = ${refdir}/1276619416_20200619163000_vis_imag_channel${ch_str}_time000000_pol0.fits -p 0.5 -p 0.5
