...
echo "blink_pipeline -c 4 -C -736 -t 1.00s -o ch -n 8192 -f ${freq_mhz} -F 30 -M 20200619163000.metafits -U 1592584240 -w N -v 100 -r -L -G -s calsolutions -r -V 100 -A 21,25,58,71,80,81,92,101,108,114,119,125 1276619416_1276619418_ch${coarse_channel}.dat > 156.out 2>&1"
blink_pipeline -c 4 -C -736 -t 1.00s -o ch -n 8192 -f ${freq_mhz} -F 30 -M 20200619163000.metafits -U 1592584240 -w N -v 100 -r -L -G -s calsolutions -r -V 100 -A 21,25,58,71,80,81,92,101,108,114,119,125 1276619416_1276619418_ch${coarse_channel}.dat > 156.out 2>&1
