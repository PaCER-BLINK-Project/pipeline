...
echo "cp $BLINK_TEST_DATADIR/mwa/1276619416/calsolutions_chan000_xx.txt ."
cp $BLINK_TEST_DATADIR/mwa/1276619416/calsolutions_chan000_xx.txt .

echo "cp $BLINK_TEST_DATADIR/mwa/1276619416/calsolutions_chan001_xx.txt ."
cp $BLINK_TEST_DATADIR/mwa/1276619416/calsolutions_chan001_xx.txt .

echo "cp $BLINK_TEST_DATADIR/mwa/1276619416/calsolutions_chan750_xx.txt ."
cp $BLINK_TEST_DATADIR/mwa/1276619416/calsolutions_chan750_xx.txt .

echo "------------------------------------------"
mkdir -p ch000 ch001 ch750

# was originally using /software/projects/director2183/msok/blink_pipeline/gpu/pipeline/build_gpu/blink_pipeline
echo "./blink_pipeline -c 4 -C 0 -t 1.00s -o ch000/ -n 8192 -f 169.6000 -F 30 -M 20200619163000.metafits -U 1592584240 -w N -v 100 -r -L -G -s calsolutions_chan000_xx.txt -r -V 100 -A 21,25,58,71,80,81,92,101,108,114,119,125  1276619416_1276619418_ch133.dat > ch000/out 2>&1"
./blink_pipeline -c 4 -C 0 -t 1.00s -o ch000/ -n 8192 -f 169.6000 -F 30 -M 20200619163000.metafits -U 1592584240 -w N -v 100 -r -L -G -s calsolutions_chan000_xx.txt -r -V 100 -A 21,25,58,71,80,81,92,101,108,114,119,125  1276619416_1276619418_ch133.dat > ch000/out 2>&1

echo "./blink_pipeline -c 4 -C 1 -t 1.00s -o ch001/ -n 8192 -f 169.6400 -F 30 -M 20200619163000.metafits -U 1592584240 -w N -v 100 -r -L -G -s calsolutions_chan001_xx.txt -r -V 100 -A 21,25,58,71,80,81,92,101,108,114,119,125  1276619416_1276619418_ch133.dat > ch001/out 2>&1"
./blink_pipeline -c 4 -C 1 -t 1.00s -o ch001/ -n 8192 -f 169.6400 -F 30 -M 20200619163000.metafits -U 1592584240 -w N -v 100 -r -L -G -s calsolutions_chan001_xx.txt -r -V 100 -A 21,25,58,71,80,81,92,101,108,114,119,125  1276619416_1276619418_ch133.dat > ch001/out 2>&1

echo "./blink_pipeline -c 4 -C 14 -t 1.00s -o ch750/ -n 8192 -f 199.6000 -F 30 -M 20200619163000.metafits -U 1592584240 -w N -v 100 -r -L -G -s calsolutions_chan750_xx.txt -r -V 100 -A 21,25,58,71,80,81,92,101,108,114,119,125  1276619416_1276619418_ch156.dat > ch750/out 2>&1"
./blink_pipeline -c 4 -C 14 -t 1.00s -o ch750/ -n 8192 -f 199.6000 -F 30 -M 20200619163000.metafits -U 1592584240 -w N -v 100 -r -L -G -s calsolutions_chan750_xx.txt -r -V 100 -A 21,25,58,71,80,81,92,101,108,114,119,125  1276619416_1276619418_ch156.dat > ch750/out 2>&1
echo "------------------------------------------"
